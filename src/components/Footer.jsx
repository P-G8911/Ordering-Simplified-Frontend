...
const Footer = () => {
  return (
    <Container>
      <Left>
        <Logo>ORDERING SIMPLIFIED.</Logo>
        <Desc>
          If you would like to experience the best of online shopping for men,
          women and kids you are at the right place. 
          <br/>
          Ordering Simplified is the ultimate destination for fashion and lifestyle,
